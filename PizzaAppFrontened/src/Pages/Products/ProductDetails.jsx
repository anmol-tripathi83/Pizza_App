...
function ProductDetails(){
    ...
    useEffect(() =>{   // when productId change it fatches the product details
        fetchProductDetails();      // useEffect function ko async banana recommended nhi hota isliye we write bind it to the function
    },[productId]);
            ...
            <section className="overflow-hidden text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap mx-auto lg:w-4/5">
                        <img
                            alt="pizza Image"
                            className="object-cover object-center w-full rounded lg:w-1/2 lg:h-auto"
